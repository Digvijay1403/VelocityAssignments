...
public class VelocityCalculator implements Addition,
        Average,
        Cube,
        Division,
        Even_Odd,
...
//        return (num1-num2);
    ...
    public void multiplicationOfTwoNums() {
        System.out.println("Enter num 1 ");
        int num1 = scan.nextInt();
        System.out.println("Enter num 2 ");
        int num2 = scan.nextInt();
...
//        return (num1-num2);
    ...
    public void moduloOfTwoNumbers() {
